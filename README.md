...
├── scripts/
│   └── package-module.sh              # Module packaging utility
...
### Local Module Packaging

Use the provided script to test module packaging locally:
...
./scripts/package-module.sh -n vpc -p aws -v 1.0.0

# Custom output file
./scripts/package-module.sh -o my-module.tar.gz
```
